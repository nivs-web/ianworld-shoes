...
export const S = {
  ...
  dragonItemBuyBtn: (n) => `구매하기 (금화 ${n.toLocaleString('en-US')}개)`,
  dragonStartNow: (what, n) => `지금은 ${what} ${n}개로 시작합니다`,
  dragonStartAfter: (n) => ` → 사면 ${n}개`,
  ...
  dragonMenuControls: '조작키 설정',
  dragonMenuSound: '사운드 설정',
  backToSettings: '설정으로 돌아가기',
  dragonKeysHint: '터치 조작은 핸드폰에서만 보입니다. 키보드와 패드는 연결하면 바로 쓸 수 있습니다',
  ...
  duelRefunded: (n) => `금화 ${n.toLocaleString('en-US')}개를 돌려드렸습니다`,
  duelRefundedWhy: '상대가 오지 않아 결투가 성립하지 않았습니다',
  duelStakeBack: (n) => `주인이 정해지지 않은 판돈 ${n.toLocaleString('en-US')} 금화를 돌려드렸습니다`,
  duelWon: '이겼습니다',
  duelLost: '졌습니다',
  ...
  duelLoseBig: '결투에서 패배하였습니다',
  duelLoseSub: '다음 판에 다시 도전해보세요',
  duelWonPotPre: '걸린',
  duelWonPotCoins: (n) => `금화 ${n.toLocaleString('en-US')}개`,
  duelWonPotPost: '를 모두 가져왔습니다',
  duelLostCoins: (n) => `내 소중한 금화 ${n.toLocaleString('en-US')}개를 뺏겼습니다`,
  duelCoinCell: (n) => `금화 ${n.toLocaleString('en-US')}`,
  duelDeadCell: '탈락',
  duelAliveCell: '생존',
  ...
  rankNotInTop: '아직 100위 안에 들지 못했습니다',
  /**
