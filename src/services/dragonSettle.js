...
/** 한 사람이 거는 금화 */
/**
 * ★ **판돈 1,000 -> 200.** (2026-08-26, 사용자 지정)
 * *"금화 1000개 모으는게 너무 힘들어"*
 *
 * 한 판 완주해야 6,000 남짓 버는데 결투 한 번에 1,000 을 걸라는 건
 * **결투를 특별한 행사로 만든다.** 자주 붙어 보라고 만든 것이 그 반대가 됐다.
 * 200 이면 싱글 한 판으로 서른 번은 붙을 수 있다 — 걸리는 것이 있되
 * 망설일 정도는 아닌 자리다.
 */
